...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("macrocoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("macrocoin://"))
    {
        uri.replace(0, 12, "macrocoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Macro.lnk";
}
...
/*
void SetSThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QMenu          { background: rgb(40,153,0); color: rgb(222,222,222); }"
                      ...
                      "QToolButton    { background: rgb(40,153,0); color: rgb(116,122,134); border: none; border-left-color: rgb(40,153,0); border-left-style: solid; border-left-width: 6px; margin-top: 8px; margin-bottom: 8px; }"
                      ...
                      "QToolBar       { background: rgb(40,153,0); border: none; }");
}

*/
void SetSThemeQSS(QApplication& app)
{
    // app.setStyleSheet("QToolBar       { background: rgb(200,200,200; border: none; }");
