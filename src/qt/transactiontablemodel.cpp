...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord *wtx) const
{
    ...
    {
    case TransactionRecord::Generated:
        return QIcon(fUseSTheme ? ":/icons/macrocoin/tx_mined" : ":/icons/tx_mined");
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
        return QIcon(fUseSTheme ? ":/icons/macrocoin/tx_input" : ":/icons/tx_input");
    case TransactionRecord::SendToAddress:
    case TransactionRecord::SendToOther:
        return QIcon(fUseSTheme ? ":/icons/macrocoin/tx_output" : ":/icons/tx_output");
    default:
        return QIcon(fUseSTheme ? ":/icons/macrocoin/tx_inout" : ":/icons/tx_inout");
    }
    return QVariant();
}
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        {
            return fUseSTheme ? QColor(0, 255, 0) : QColor(0, 128, 0);
        }
