...
static const int64_t COIN_YEAR_REWARD = 2 * CENT; // macrocoin:::  2% per year

inline bool IsProtocolV1RetargetingFixed(int nHeight) { return TestNet() || nHeight > 800; } //macrocoin:::  after pow
inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 800; } // macrocoin:::  after pow
inline bool IsProtocolV3(int64_t nTime) { return TestNet(); } // macrocoin::: -> never

inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10 * 60; } // macrocoin::: like it is...increase for test purposes
